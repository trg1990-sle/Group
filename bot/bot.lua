...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {316526076,},--Sudo users
    moderation = {data = 'data/moderation.json'},
    about_text = [[
	TRGsecurity Group manager :
		channel ID : @TRGsecurity_GroupManager
		Admin ID : @TRG_sle
    ...
    help_text = [[ 
	راهنمای بات ضد اسپم TRGsecurity

#ban [يوزرنيم | ايدي | ريپلي]
اخراج کردن یک فرد از گروه به صورت دائمی

#unban [‎يوزرنيم | ايدي | ريپلي]
خارج کردن یک فرد از حالت اخراج دائمی!

#kick ‎[يوزرنيم | ايدي | ريپلي]
کیک کردن یک فرد از گروه

#muteuser‎ [يوزرنيم | ايدي | ريپلي]
سایلنت کردن یک کاربر خاص در گروه

#unmuteuser‎ [يوزرنيم | ايدي | ريپلي]
آنسایلنت کردن یک کاربر خاص در گروه

#delall [يوزرنيم | ايدي | ريپلي]
حذف تمامى پيام هاى يك فرد از گروه
...
#clean [bots|chats|banlist|modlist|mutelist|filterlist]

پاک کردن [ربات ها|چت ها|ليست افراد بن شده|ليست مدير هاي گروه|ليست افراد ميوت شده|ليست كلمات فيلتر شده]
...
#modlist
نمایش مدیران ربات در گروه( افرادی که توسط Owner ادمین شدند.

#promote‎ [يوزرنيم | ايدي | ريپلي]
ارتقاء مقام کاربر به ناظم گروه (فقط  اونر های گروه میتوانند پروموت کنند!!)

#demote‎ [يوزرنيم | ايدي | ريپلي]
...
نمایش قوانین
➖➖➖➖➖➖
#lock [links|edit|pin|flood|spam|arabic|member|rtl|sticker|reply|kickme|TgService|contacts|forward|badword|emoji|english|tag|webpage]
...
#mute [all|music|voice|gifs|photo|video|text]
پاک کردن سریع همه پیغام ها-عکس ها-گیف ها-صدا های ضبط شده-فیلم-متن

#unmute [all|music|voice|gifs|photo|video|text]
باز کردن قفل امکانات بالا
...
➖➖➖➖➖➖
#pin [ريپلى]
پين كردن پيام مورد نظر توسط ربات

#unpin
آنپين كردن پيام پين شده

#repin
پين كردن آخرين پيام پين شده با ربات
➖➖➖➖➖➖
